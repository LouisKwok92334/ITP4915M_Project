...
namespace ITP4915M_Project {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class StaffDataTable : global::System.Data.TypedTableBase<StaffRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StaffRow AddStaffRow(string staffID, string staffName, string userName, string password) {
...
namespace ITP4915M_Project.Database1DataSetTableAdapters {
    ...
    public partial class StaffTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Staff` WHERE ((`staffID` = ?) AND ((? = 1 AND `staffName` IS NULL) O" +
                "R (`staffName` = ?)) AND ((? = 1 AND `userName` IS NULL) OR (`userName` = ?)) AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Staff` (`staffID`, `staffName`, `userName`, `password`) VALUES (?, ?" +
                ", ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Staff` SET `staffID` = ?, `staffName` = ?, `userName` = ?, `password` = ? WHERE ((`staffID` = ?) AND ((? = 1 AND `staffName` IS NULL) OR (`staffName` = ?)) AND ((? = 1 AND `userName` IS NULL) OR (`userName` = ?)) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ITP4915M_Project.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT staffID, staffName, userName, [password] FROM Staff";
        ...
        public virtual int Delete(string Original_staffID, string Original_staffName, string Original_userName, string Original_password) {
        ...
        public virtual int Insert(string staffID, string staffName, string userName, string password) {
            if ((staffID == null)) {
        ...
        public virtual int Update(string staffID, string staffName, string userName, string password, string Original_staffID, string Original_staffName, string Original_userName, string Original_password) {
            if ((staffID == null)) {
                throw new global::System.ArgumentNullException("staffID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string staffName, string userName, string password, string Original_staffID, string Original_staffName, string Original_userName, string Original_password) {
            return this.Update(Original_staffID, staffName, userName, password, Original_staffID, Original_staffName, Original_userName, Original_password);
        }
    }
